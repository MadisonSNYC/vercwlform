...
import { TikTokIcon } from "@/components/icons/tiktok-icon" // Corrected import path
  ...
  return (
    <div className="flex flex-col min-h-[100dvh]">
      <main className="flex-1">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                    Welcome to The NYC Agent
                  </h1>
                  <p className="max-w-[600px] text-gray-300 md:text-xl">
                    Your trusted partner in navigating the New York City real estate market.
                  </p>
                </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  I offer a range of services to help you navigate the complexities of the NYC real estate market.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl items-start gap-8 sm:grid-cols-2 md:gap-12 lg:grid-cols-3">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Find your perfect rental in NYC with ease and confidence.</CardDescription>
                </CardHeader>
                <CardContent>
                  <ul className="text-sm text-gray-500 dark:text-gray-400">
                    <li>Extensive rental listings</li>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  Follow me on social media for the latest updates, market insights, and NYC real estate tips.
                </p>
              </div>
        ...
        {/* Navigation */}
        <nav
          className={`fixed top-0 left-0 right-0 z\`\`\`xml
        </section>
        {/* Navigation */}
        <nav
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <label className="flex items-start">
                      ...
                      <span className="text-sm text-blue-800">
                        I agree to receive updates about NYC FARE Reporter and be added to The NYC Agent mailing list
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="border-t pt-6">
                        ...
                        <p className="text-sm text-gray-600 mb-4">
                          Select at least one violation (you can select multiple). For more information about your
                          rights, check out the FARE Act:{" "}
                          <a
                            href="https://council.nyc.gov/chi-osse/the-fare-act/"
                            target="_blank"
                            rel="noopener noreferrer"
                          ...
                          <div key={category} className="mb-6">
                            ...
                            {category === "fee" && (
                              <p className="text-sm text-gray-500 mb-2">
                                Note: Application fees can vary for co-ops and condos. The "$20 cap" for application
                                fees does not apply to co-op or condo application fees.
                              </p>
                            )}
                          ...
                          <div>
                            ...
                            <div className="space-y-2">
                              ...
                              <label className="flex items-center">
                                ...
                                />
                                <span>
                                  I would like AI to refine this report and email me a draft before submission
                                </span>
                              </label>
                              <label className="flex items-center">
                                <input
                        ...
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                handleInputChange("preferredContact", e.target.value as "email" | "phone")
                              }
                              className={commonInputClasses}
                            >
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                          <label className="flex items-start">
                            ...
                            <span className="text-sm text-blue-800">
                              ...
                              information to the NYC Department of Consumer and Worker Protection (DCWP) and that DCWP
                              may use this information to investigate the business, enforce the law, or for other
                              purposes authorized by law. I also understand that DCWP may share this information with
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                          <label className="flex items-start">
                            ...
                            <span className="text-sm text-blue-800">
                              ...
                              understand that NYC FARE Reporter is not legally liable for the content or outcomes of
                              this submission." *
                            </span>
                          </label>
                        </div>
              ...
              <div id="confirmation" className="bg-white rounded-lg p-8 text-center shadow-lg">
                ...
                <div className="border-t border-gray-200 pt-8 mt-8">
                  ...
                  <p className="text-lg text-gray-700 mb-8 max-w-3xl mx-auto">
                    If this tool helped you, help us reach more renters who need it. Every follow, share, or coffee
                    makes a real difference in getting these tools to the people who need them most.
                  </p>
                  <div className="mb-8">
                    <a
                      href="https://buymeacoffee.com/thenycagent"
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-xl p-6 shadow-md">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Anyone who believes they have been subjected to a violation of the FARE Act in New York City can file
                  a report. This includes prospective tenants, current tenants, and anyone involved in a rental
                  transaction where illegal fees or practices have occurred.
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-md">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  Department of Consumer and Worker Protection (DCWP) and the NYS Department of State. You will be CC'd
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 dark:text-gray-400">© 2024 The NYC Agent. All rights reserved.</p>
