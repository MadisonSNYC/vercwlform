...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ref={ref}
    className={cn(
      "left-0 top-0 w-full data-[animate-in]:fade-in data-[animate-out]:fade-out data-[animate-in]:slide-in-from-top-1 data-[animate-out]:slide-out-to-top-1 md:absolute md:w-auto md:data-[animate-in]:zoom-in-90 md:data-[animate-in]:slide-in-from-top-2 md:data-[animate-out]:zoom-out-90 md:data-[animate-out]:slide-out-to-top-2",
